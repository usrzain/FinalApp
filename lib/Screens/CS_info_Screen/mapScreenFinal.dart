// ignore_for_file: unused_field, prefer_final_fields, library_private_types_in_public_api, unused_import, unnecessary_import, dead_code, prefer_typing_uninitialized_variables, duplicate_import, non_constant_identifier_names, use_build_context_synchronously, empty_catches, no_leading_underscores_for_local_identifiers
...
class _MapScreenState extends State<MapScreenFinal> {
        ...
        if (snapshot.value != null) {
          ...
          data.forEach((key, value) async {
            ...
            double? cLat = Provider.of<chDataProvider>(context, listen: false)
                .currentLocation!
                .latitude;
            double? cLong = Provider.of<chDataProvider>(context, listen: false)
                .currentLocation!
                .longitude;
          ...
          body: Stack(
            children: [
              ...
              Consumer<chDataProvider>(
                builder: (context, dataProvider, child) {
                  return dataProvider.markerLoadingComplete
                      ? Stack(
                          children: [
                            GoogleMap(
                              ...
                              initialCameraPosition: CameraPosition(
                                ...
                                zoom: dataProvider.polyLineDone ? 20 : 12,
                              ),
                              onMapCreated: (GoogleMapController controller) {
                                _mapController = controller;
                              },
                              markers: dataProvider.markers,
                              polylines: dataProvider.polyLineDone
                                              ...
                                              ? IconButton(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    dataProvider.stateOfCharge =
                                                        null;
                                                    dataProvider.vehBrand =
                                                        null;
                                                    dataProvider.vehModel =
                                                        null;
                                                    dataProvider.showReset =
                                                        true;
                                                  },
                                                )
                                              : IconButton(
...
class SearchBarWithFilter extends StatelessWidget {
  const SearchBarWithFilter(
      {Key? key, required Future<void> Function() onPressedFilter})
      : super(key: key);
